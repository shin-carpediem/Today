...
final class ReminderListViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        let headerRegistration = UICollectionView.SupplementaryRegistration(elementKind: ProgressHeaderView.elementKind, handler: supplymentaryRegistrationHandler)
    ...
    private func supplymentaryRegistrationHandler(progressView: ProgressHeaderView, elementKind: String, indexPath: IndexPath) {
